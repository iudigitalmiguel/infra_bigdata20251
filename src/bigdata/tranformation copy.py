...
class DataEnrichmentProcessor:
    ...
    def __init__(self):
        ...
        # Rutas de salida
        self.enriched_data_path = 'src/bigdata/static/db/xlsx/enriched_data.xlsx'
    ...
    def split_base_dataset(self):
        ...
        part1_csv_path = 'src/db/anime_part1.csv'
        part2_json_path = 'src/db/anime_part2.json'
    ...
    def _create_additional_excel(self):
        ...
        # Guardar como Excel
        xlsx_path = 'src/db/anime_extra.xlsx'
    ...
    def _create_additional_xml(self):
        ...
        # Guardar como XML
        xml_path = 'src/db/anime_categories.xml'
    ...
    def read_additional_sources(self):
        ...
        try:
            # 1. Leer CSV
            csv_path = 'src/db/anime_part1.csv'
            ...
            # 2. Leer JSON
            json_path = 'src/db/anime_part2.json'
            ...
            # 3. Leer Excel
            excel_path = 'src/db/anime_extra.xlsx'
